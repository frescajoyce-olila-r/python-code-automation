...
ZIP_FROM = 1000
ZIP_TO = 9999
URL = f'https://www.byggaranti.dk/byggaranti/sogeside?SearchQuery=&zipFrom={ZIP_FROM}&zipTo={ZIP_TO}&Page=1'
...
PROFESSIONS = {
    ...
    'Tag og facade':'123,124,128,103,101,101,114,116,102',                             # Tag og facade
    ...
    'Tagmaler': '1115',                                                                # Tagmaler
    'Tækkearbejde': '4685',                                                            # Tækkearbejde

}

LOADED_PROFESSIONS = ['Tømrer og snedker']


class DanskindustriSpider(scrapy.Spider):
    name = 'byggaranti'
    allowed_domains = ['byggaranti.dk']
